...
function init() {
    ...
    transform = typeof (body.style.webkitTransform) != 'undefined' ? 'webkitTransform' : (typeof (body.style.msTransform) !=
        'undefined' ? 'msTransfrm' : 'transform');
...
function gameTime() {
    _gameTimeNum--;
    if (_gameTimeNum <= 0) {
        GameTimeLayer.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;恭喜你完成了';
        gameOver();
...
function showGameScoreLayer() {
    ...
    var score_text='得分&nbsp;&nbsp;';
    score_text+=deviation_time<23000?_gameScore:"<span  ='color:red;'>"+_gameScore+"</span>";
